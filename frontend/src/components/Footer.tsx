        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <svg width="140" height="38" viewBox="0 0 140 38" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="text-sm">
                Transformando el análisis de datos con inteligencia artificial
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/solutions" className="hover:text-white">Soluciones</a></li>
                <li><a href="https://relais.boko.com.au/membership" className="hover:text-white">Precios</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://relais.boko.com.au/sobre-nosotros/nuestro-equipo" className="hover:text-white">Acerca de nosotros</a></li>
                <li><a href="mailto:contacto@relaisoft.org" className="hover:text-white">contacto@relaisoft.org</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Legal</h3>
              <ul className="space-y-2">
                <li><a href="/terms" className="hover:text-white">Privacidad</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-sm">
            <p>© 2025 Relais. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
  )
