                ...
                <div className="mt-8 space-y-6">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Ingresa tu dirección de correo electrónico y te enviaremos un correo electrónico para restablecer tu contraseña
                        </p>
                    </div>
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm font-medium text-green-800">
                                        Se han enviado instrucciones de restablecimiento a tu dirección de correo electrónico.
                                    </p>
                                    {/* <small>Didn't receive an email? <span className='text-blue-500 cursor-pointer'>Resend</span></small> */}
                                </div>
                            </div>
                        </div>
                    ) : (
