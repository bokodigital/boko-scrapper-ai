...
export default function ErrorPagee() {
  const navigate = useNavigate()

  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Navigation */}
      <nav className="w-full bg-white border-b border-gray-100 h-16">
      ...
      <div className="flex-grow flex items-center justify-center p-4">
        <div className="max-w-2xl w-full text-center space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative">
              <svg
                className="w-full h-64 mx-auto text-gray-400"
                viewBox="0 0 400 300"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <circle cx="200" cy="150" r="100" className="fill-blue-100" />
                <text
                  x="200"
                  y="180"
                  textAnchor="middle"
                  className="fill-blue-600 text-9xl font-bold"
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-md mx-auto">
              Lo sentimos, no pudimos encontrar la página que está buscando. Es posible que haya sido movida o eliminada.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => navigate(-1)}
              className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
            ...
            <button
              onClick={() => navigate('/')}
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
            >
          ...
          <div className="pt-8 border-t border-gray-200">
            <p className="text-base text-gray-600">
              ¿Necesitas ayuda? Intenta estos recursos:
            </p>
            <div className="mt-4 flex flex-wrap justify-center gap-4 text-sm">
              <span className="text-gray-300">•</span>
              <a
                href="mailto:contacto@relaisoft.org"
      ...
      {/* Footer */}
      <footer className="w-full py-4 px-4 border-t border-gray-100">
